...
class StageEditorState extends MusicBeatState
{
    ...
    override function create() {
        ...
        betaTXT = new FlxText(12, FlxG.height - 44, 0, "WORK IN PROGRESS \n FEATURES COULD BE BUGGY/BROKEN", 20);
    ...
    var spritesDropDown:FlxUIDropDownMenu;
    ...
    function addAddRemoveUI() {
        ...
        spritesDropDown = new FlxUIDropDownMenu(objectInputText.x, objectInputText.y + 60, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(sprite:String)
		{
            bgLayer.update(1);
    ...
    var dadSelect:FlxUIDropDownMenu;
    var bfSelect:FlxUIDropDownMenu;
    var gfSelect:FlxUIDropDownMenu;
    ...
    function addCharactersUI() {
        ...
        dadSelect = new FlxUIDropDownMenu(10, 30, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(sprite:String)
            {
                //dad.x = 0;
                //dad.y = 0;
        ...
        bfSelect = new FlxUIDropDownMenu(dadSelect.x+130, dadSelect.y, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(sprite:String)
            {
                //dad.x = 0;
                //dad.y = 0;

                charLayer.remove(bf);
                bf = new Character(bf.x, bf.y, characterList[Std.parseInt(sprite)]);
        ...
        gfSelect = new FlxUIDropDownMenu(dadSelect.x - 130, dadSelect.y, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(sprite:String)
            {
                //dad.x = 0;
                //dad.y = 0;
        ...
        charDropDown = new FlxUIDropDownMenu(gfSelect.x-130, dadSelect.y, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(character:String)
		{
    ...
    function reloadCharDrops() {
		...
		dadSelect.setData(FlxUIDropDownMenu.makeStrIdLabelArray(characterList, true));
        bfSelect.setData(FlxUIDropDownMenu.makeStrIdLabelArray(characterList, true));
        gfSelect.setData(FlxUIDropDownMenu.makeStrIdLabelArray(characterList, true));
    ...
    function reloadCharacterDropDown() {
		charDropDown.setData(FlxUIDropDownMenu.makeStrIdLabelArray(charactersOnStage, true));
	}

    function reloadSpritesDropdown() {
        bgLayer.update(1);
        spritesDropDown.setData(FlxUIDropDownMenu.makeStrIdLabelArray(spritesLayer, true));
    }
